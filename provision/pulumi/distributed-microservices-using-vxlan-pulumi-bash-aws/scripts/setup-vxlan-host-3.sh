...
sudo docker network create --subnet=10.10.0.0/16 --gateway=10.10.0.1 --driver=bridge -o "com.docker.network.bridge.name"="br-vxlan" br-vxlan
...
sudo bridge fdb append 00:00:00:00:00:00 dev vxlan0 dst ${VM1_PRIVATE_IP}
